export default {
  ...
  columns: ["title","quadrant","createUid","owner","status","updateGmt"],
  ...
  slots: {
    ...
    action$({ row }) {
      return (
        <>
          <z-action p='qnxgroya' label='修改' mode='dialog' fields={["title","content","parentId","projectId","order","start","end","createUid","owner","quadrant","status","tag","remind","plan","createGmt","updateGmt","step","watchers","notes"]} link data={row} url='/do/patch/thing' />
        </>
      )
    }
  }
