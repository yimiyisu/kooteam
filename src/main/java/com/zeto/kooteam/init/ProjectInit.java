...
public class ProjectInit {
    ...
    public static void execute(ZenUser user) {
        ...
        data.set("todo", "8");
        data.set("board", "{\"id\":8308,\"content\":[{\"title\":\"了解Kooteam\",\"tag\":\"t1\",\"sons\":[]}," +
        ...
        ZenData param = ZenData.put("userId", user.getUid()).
                set("projectId", result.get("_id")).set("role", "5");
        ...
        example.set("projectId", _id);
        example.set("tag", "t1");
        example.set("title", "快速了解「文档」功能");
        example.set("content", "<p>文档，不仅仅只是文本。还支持在线绘制<b>流程图</b>和<b>思维导图</b>，从此告别庞大的第三方软件。</p>\n");
